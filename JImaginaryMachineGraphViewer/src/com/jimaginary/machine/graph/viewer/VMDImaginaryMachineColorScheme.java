 ...
 * @author David Kaspar
 */
public class VMDImaginaryMachineColorScheme extends VMDColorScheme {

    /*
    static final Color COLOR_NORMAL = new Color (186,205,240);//(0xBACDF0);
    private static final Color COLOR_HOVERED = Color.BLACK;
    private static final Color COLOR_SELECTED = new Color (116,140,192);//(0x748CC0);
    static final Color COLOR_HIGHLIGHTED = new Color (49,106,197);//(0x316AC5);
    */
    ...
    static final Color COLOR_CONNECTION = new Color (246,105,140);//(0xBACDF0);

//    private static final Color COLOR0 = new Color (169, 197, 235);
    static final Color COLOR1 = new Color (121, 235, 246);
    static final Color COLOR2 = new Color (155, 255, 255);
    static final Color COLOR3 = new Color (114, 235, 255);
    static final Color COLOR4 = new Color (141, 249, 253);
    static final Color COLOR5 = new Color (155, 255, 255);
    ...
    */
    ...
    static final Color BORDER_CATEGORY_BACKGROUND = new Color (155, 255, 255);//(0xCDDDF8);
    ...
    public VMDImaginaryMachineColorScheme () {
    }
    ...
    public void updateUI (VMDConnectionWidget widget, ObjectState previousState, ObjectState state) {
        if (state.isHovered ())
            ...
            widget.setForeground (COLOR_CONNECTION);
